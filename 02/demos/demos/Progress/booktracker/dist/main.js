...
var routes = [
    { path: 'dashboard', component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], resolve: { resolvedBooks: _core_book_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BookResolverService"] } },
...
var BookResolverService = /** @class */ (function () {
    function BookResolverService(dataService) {
        this.dataService = dataService;
    }
    BookResolverService.prototype.resolve = function (route, state) {
        return this.dataService.getAllBooks().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(err); }));
    };
...
/* harmony import */ var app_core_add_header_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/core/add-header.interceptor */ "./src/app/core/add-header.interceptor.ts");
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: app_core_add_header_interceptor__WEBPACK_IMPORTED_MODULE_7__["AddHeaderInterceptor"], multi: true },
...
module.exports = __webpack_require__(/*! D:\projects\GitHub\pluralsight\angular-http-communication\02\demos\demos\Progress\booktracker\src\main.ts */"./src/main.ts");
